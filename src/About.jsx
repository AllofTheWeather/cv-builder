export default function About() {
    return (
        <>  
            ...
            <div className="container p-5">
                <p>C.V. Builder uses ReactJS to store your information in client side state. The data is then passed as props to the C.V. copmponent which handles the layout. From here it can be exported as a PDF.</p>
